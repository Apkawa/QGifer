...
void OptimizerDialog::checkIM() {
    ...
    if (!c) {
        ...
        msgLabel->setText(
                tr("Error: this operation requires the ImageMagick installed on your system. Please install ImageMagick or choose the directory with \"convert\" executable file."));
    }
